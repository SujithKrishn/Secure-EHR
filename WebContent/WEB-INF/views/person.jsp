	...
	<tr>
		...
		<td>
			<form:select path="country">
			  <form:option value="Select" label="Select One"></form:option>
			    <form:option value="A+" label="India"></form:option>
	...
	<tr>
		...
		<td>
			  ...
			  <form:option value="NA" label="Select One"></form:option>
			    ...
			    <form:option value="Airborne disease" label="Contagious disease"></form:option>
			    <form:option value="Airborne disease" label="Cryptogenic disease"></form:option>
			    <form:option value="Airborne disease" label="Disseminated disease"></form:option>
			    <form:option value="Airborne disease" label="Lifestyle disease"></form:option>
			    <form:option value="Airborne disease" label="Progressive disease"></form:option>
			    <form:option value="Airborne disease" label="Rare disease"></form:option>
			</form:select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<form:label path="isUndergoneSurgery">
				<spring:message text="Is Undergone Surgery"/>
			</form:label>
		</td>
		<td>
	...
	<tr>
		<td>
			<form:label path="isEyeSightProblem">
				<spring:message text="Is eye Sight Problem"/>
			</form:label>
		</td>
		<td>
	...
	<tr>
		<td>
			<form:label path="isHandicapped">
				<spring:message text="Is Handicapped"/>
			</form:label>
		</td>
		<td>
	...
	<tr>
		<td>
			<form:label path="hasCancer">
				<spring:message text="Has Cancer"/>
			</form:label>
		</td>
		<td>
	...
	<tr>
		<td>
			<form:label path="hasDiabetis">
				<spring:message text="Has Diabetis"/>
			</form:label>
		</td>
		<td>
	...
	<tr>
		<td>
			<form:label path="hasBloodPressure">
				<spring:message text="Has BloodPressure"/>
			</form:label>
		</td>
		<td>
	...
	<tr>
		<td>
			<form:label path="hasSTD">
				<spring:message text="Has STD"/>
			</form:label>
		</td>
		<td>
			<form:input path="hasSTD" />
		</td>
	</tr>
	<tr>
		<td>
...
<c:if test="${!empty listPersons}">
	...
	<tr>
		...
		<th width="120">Is Undergone Surgery</th>
		<th width="120">Temporary Address</th>
		<th width="120">Permanent Address</th>
		<th width="120">Has eyeSight Problem</th>
		<th width="120">Left Eye Power</th>
		<th width="120">Right Eye Power</th>
		<th width="120">Is Handicapped</th>
		<th width="120">Has Polio</th>
		<th width="120">Has Cancer</th>
		<th width="120">Cancer Type</th>
		<th width="120">Has Diabetis</th>
		<th width="120">Has BloodPressure</th>
		<th width="120">Has STD</th>
		<th width="60">Edit</th>
